...
if (recognition) {
    ...
    function speakText(textToSpeak) {
        ...
        // English male voices ko dhoondne ke liye keywords filter karein
        ...
        // Agar male voice mil jaye toh apply karein, nahi toh default chalne dein
        if (maleVoice) {
            utterance.voice = maleVoice;
        }

        // Jarvis feel dene ke liye thodi si pitch aur rate kam kar sakte hain (Optional)
        utterance.rate = 1.0;  // Bolne ki raftar (0.1 se 10)
        utterance.pitch = 0.9; // Awaz thodi bhari (deep) karne ke liye (0 se 2)
        // ----------------------------------
    ...
    // Chrome aur kuch browsers me voices asynchronously load hoti hain, 
    // isliye unhe pehle se load karwana behtar hota hai.
